...
CREATE TABLE `User` (
    ...
    `sexualPreference` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Like` ADD CONSTRAINT `Like_giverId_fkey` FOREIGN KEY (`giverId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
